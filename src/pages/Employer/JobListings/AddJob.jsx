        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 mb-6 border-l-4 border-blue-600">
            <div className="flex items-center justify-between gap-8">
              {/* Title Section */}
              <div>
                <h1 className="text-3xl font-bold text-gray-800 mb-2">Post New Job</h1>
            ...
            {currentStep === 2 && (
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600">Break down your project into manageable milestones (Optional)</p>
                </div>
                ...
                <div className="flex gap-4 pt-6 border-t-2 border-gray-200">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-lg hover:from-blue-700 hover:to-blue-600 transition-all font-semibold disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
                  >
                    {loading ? (
                      <>
