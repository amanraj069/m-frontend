...
const JobDescription = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50">
      ...
      {/* Footer */}
      <footer className="bg-gray-900 text-white py-16 mt-16" id="footer">
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              <h3 className="text-2xl font-bold mb-4">Milestone</h3>
              <p className="text-gray-400 mb-6 leading-relaxed">
                The world's largest freelancing platform connecting businesses with
                skilled professionals.
              </p>
              <div className="flex gap-4">
                <a
                  href="#"
                  className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-white transition-all hover:bg-blue-700 hover:-translate-y-0.5"
                >
            ...
            <div>
              ...
              <ul className="list-none space-y-2">
                <li>
                  <Link
                    to="/how-it-works"
                    className="text-gray-400 no-underline transition-colors hover:text-blue-400"
                  >
                    How it Works
                  </Link>
                </li>
