...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between py-4">
            <div className="text-4xl font-bold text-gray-900">
              <Link to="/" className="hover:text-maroon-700 transition-colors">
                Mile<span className="text-maroon-700">stone</span>
              </Link>
            </div>
            <div className="flex-1 max-w-md mx-8">
              <form className="relative">
                <input 
                  ...
                  className="w-full px-5 py-3 border-2 border-gray-200 rounded-full text-sm outline-none transition-all focus:border-maroon-700 focus:ring-4 focus:ring-maroon-100"
                />
                <button type="submit" className="absolute right-1 top-1/2 -translate-y-1/2 bg-maroon-700 text-white border-none rounded-full w-9 h-9 cursor-pointer transition-all hover:bg-maroon-800 flex items-center justify-center">
            ...
            <div className="flex items-center gap-4">
              <button 
                onClick={toggleTheme}
                className="bg-transparent border-none text-lg cursor-pointer text-gray-600 transition-colors hover:text-maroon-700 p-2"
              >
              ...
              {user ? (
                <Link 
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-maroon-950 via-maroon-900 to-maroon-800 text-white rounded-lg font-medium no-underline transition-all hover:shadow-lg hover:-translate-y-0.5"
                >
      ...
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-maroon-800 via-maroon-700 to-maroon-600 text-white pt-32 pb-20 px-8 min-h-screen flex items-center overflow-hidden">
        <div className="max-w-7xl mx-auto relative z-10 text-center">
          ...
          <div className="flex gap-6 justify-center flex-wrap fade-in">
            <Link 
              to="/jobs" 
              className="inline-flex items-center gap-2 px-8 py-4 bg-white text-maroon-700 rounded-lg font-semibold no-underline transition-all hover:shadow-xl hover:-translate-y-1"
            >
            ...
            {user && user.role === 'Employer' && (
              <Link 
                ...
                className="inline-flex items-center gap-2 px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-semibold no-underline transition-all hover:bg-white hover:text-maroon-700"
              >
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-20 max-w-4xl mx-auto">
            <h2 className="text-5xl font-semibold mb-6 text-gray-900 leading-tight">
              Our <span className="text-maroon-700">achievement</span> at a glance
            </h2>
          </div>
      ...
      {/* Features Section */}
      <section className="py-32 bg-maroon-50" id="features">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-20 max-w-4xl mx-auto">
            <h2 className="text-5xl font-semibold mb-6 text-gray-900 leading-tight">
              Everything You Need to <span className="text-maroon-700">Succeed</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
            {[
              ...
              <div key={idx} className="bg-white p-12 rounded-2xl text-center transition-all hover:-translate-y-1 hover:shadow-xl border border-gray-100 hover:border-maroon-700">
                <div className="w-20 h-20 bg-gradient-to-br from-maroon-950 to-maroon-800 rounded-2xl flex items-center justify-center mx-auto mb-6">
        ...
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="max-w-md mx-auto">
            <div className="bg-white rounded-2xl p-8 shadow-xl relative border border-gray-100">
              ...
              <button className="w-full px-6 py-3 bg-gradient-to-r from-maroon-950 via-maroon-900 to-maroon-800 text-white rounded-lg font-semibold transition-all hover:shadow-lg hover:-translate-y-0.5">
                Hire Now
              </button>
            </div>
          </div>
          <div className="flex justify-center gap-4 mt-8">
            <button onClick={prevFreelancer} className="w-12 h-12 rounded-full bg-maroon-700 text-white cursor-pointer transition-all hover:bg-maroon-800 hover:scale-110 flex items-center justify-center border-none">
              <i className="fas fa-chevron-left"></i>
            </button>
            <button onClick={nextFreelancer} className="w-12 h-12 rounded-full bg-maroon-700 text-white cursor-pointer transition-all hover:bg-maroon-800 hover:scale-110 flex items-center justify-center border-none">
      ...
      <section className="py-20 bg-maroon-50" id="testimonials">
        <div className="max-w-7xl mx-auto px-8">
          <div className="text-center mb-12">
          ...
          <div className="flex justify-center gap-4 mt-8">
            <button onClick={prevTestimonial} className="w-12 h-12 rounded-full bg-maroon-700 text-white cursor-pointer transition-all hover:bg-maroon-800 hover:scale-110 flex items-center justify-center border-none">
              <i className="fas fa-chevron-left"></i>
            </button>
            <button onClick={nextTestimonial} className="w-12 h-12 rounded-full bg-maroon-700 text-white cursor-pointer transition-all hover:bg-maroon-800 hover:scale-110 flex items-center justify-center border-none">
              <i className="fas fa-chevron-right"></i>
            </button>
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-gradient-to-br from-maroon-950 via-maroon-900 to-maroon-800 text-white text-center">
        <div className="max-w-4xl mx-auto px-8">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <Link to="/signup" className="px-8 py-4 bg-white text-maroon-700 rounded-lg font-semibold no-underline transition-all hover:shadow-xl hover:-translate-y-1 inline-block">
              Get Started
            </Link>
            <Link to="/jobs" className="px-8 py-4 bg-transparent border-2 border-white text-white rounded-lg font-semibold no-underline transition-all hover:bg-white hover:text-maroon-700 inline-block">
              Browse Jobs
            </Link>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center text-white transition-all hover:bg-maroon-700 hover:-translate-y-0.5">
            ...
            <div>
              ...
              <ul className="list-none space-y-2">
                <li><Link to="/how-it-works" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">How it Works</Link></li>
                <li><Link to="/talent" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">Browse Talent</Link></li>
                <li><Link to="/post-job" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">Post a Job</Link></li>
                <li><Link to="/enterprise" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">Enterprise</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-white">For Freelancers</h4>
              <ul className="list-none space-y-2">
                <li><Link to="/jobs" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">Find Jobs</Link></li>
                <li><Link to="/resources" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">Resources</Link></li>
                <li><Link to="/community" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">Community</Link></li>
                <li><Link to="/success-stories" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">Success Stories</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-semibold mb-4 text-white">Company</h4>
              <ul className="list-none space-y-2">
                <li><Link to="/about" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">About Us</Link></li>
                <li><Link to="/careers" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">Careers</Link></li>
                <li><Link to="/press" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">Press</Link></li>
                <li><Link to="/contact" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">Contact</Link></li>
              </ul>
            </div>
          </div>
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-800 text-gray-400">
            ...
            <div className="flex gap-8 mt-4 md:mt-0">
              <Link to="/privacy" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">Privacy Policy</Link>
              <Link to="/terms" className="text-gray-400 no-underline transition-colors hover:text-maroon-400">Terms of Service</Link>
            </div>
          </div>
        </div>
      </footer>
